...
:_public_repo_url: https://github.com/AjuntamentdeBarcelona/innovative-procurement-bcn-en
//
// MANDATORY.
:_url: https://barcelona.cat/digitalstandards/en/innovative-procurement/
//
// MANDATORY. Title of the document. In web format, it appears as a heading of
// level 1. In PDF format, it appears in a title page.
:_title: Innovative Public Procurement Guide
//
...
:_summary: The transformation of procurement to obtain solutions that are tailored to the real needs of society, while helping companies to be more innovative.
//
// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: ethical digital standards, technology rights, barcelona, city council, procurement, innovative
//
