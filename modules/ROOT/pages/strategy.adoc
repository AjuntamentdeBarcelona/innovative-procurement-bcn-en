...
TIP: Different procurement strategies +
Specialised teams +
...
TIP: A *political mandate* at the highest level, with long-term planning of procurements with professional, stable teams.
 +
